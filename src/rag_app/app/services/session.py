...
########################################
    ...
    def cli_parse_prompt(self, prompt: str) -> tuple[str, list[str] | None]:
        if "--" not in prompt:
            return prompt, None
...
### depricated, as LiteLLM was removed and 
### this has to be handled with the requests/ OpenAI endpoint,
