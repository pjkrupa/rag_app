...
Originally, I tried to use Open-WebUI for this, but the RAG and tool-calling options were too opinionated and black-boxy, so I rolled my own. Right now, this app is tightly-coupled in a several ways that would make it hard for someone who is not me to use it:
...
* That Chroma server needs to have data in its database. For mine, I scraped and chunked the GDPR and all the recommendations and guidelines issued by the European Data Protection Board (EDPB). It took a lot of work. You can also do this work, if you want.
